...
#define ANTI_ESCAPE ANTI_ESCAPE_ACTUALLY*ANTI_ESCAPE_ACTUALLY
    ...
    if (showHelpMenu) {
      ...
      helpMenu.setString(
        ...
        "      Shift-J to use current C        V - Draw the hole. V again, draw inverse. V a few times more is unimplemeneted. Shift-V to cancel hole.\n"
        "      Alt-J to toggle inverse Julia   Z - Toggle Showing Mandelbrot half-steps.\n"
        "  F1 - Mandelbrot Set                 G - Cycle grid drawing states\n"
        "  F2 - Dumb Mandelbrot                L - Toggle labels\n"
        "  F3 - Feather Fractal                E - Draw exponential steps (1,2,4,8th step...)\n"
        "  F4 - SFX Fractal                  [ ] - Inc/decrease iterations *2 (shift-[] for drawn lines, ctrl-[] steps +1) \n"
        "  F5 - Hénon Map                      Z - Show Mandelbrot Half-steps\n"
        "  F6 - Duffing Map                    N - Use cyclic colors (each N adds another color, shift-N removes one)\n"
